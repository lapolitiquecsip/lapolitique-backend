...
export const OFFICIAL_SOURCES: SourceDefinition[] = [
  ...
  { slug: "sdes-rpls", domain: "territories", producer: "SDES", datasetName: "RPLS au 1er janvier 2024 - données nationales", datasetUrl: "https://www.statistiques.developpement-durable.gouv.fr/54-millions-de-logements-locatifs-sociaux-en-france-au-1er-janvier-2024", licence: "Licence Ouverte 2.0", expectedFrequency: "1 year" },
  ...
  { slug: "depp-bac", domain: "territories", producer: "DEPP", datasetName: "Réussite au baccalauréat par département", datasetUrl: "https://data.education.gouv.fr/explore/dataset/fr-en-baccalaureat-par-departement/", licence: "Licence Ouverte 2.0", expectedFrequency: "1 month" },
  { slug: "atmo-index", domain: "territories", producer: "Atmo France / AASQA", datasetName: "Indice ATMO quotidien par commune", datasetUrl: "https://www.data.gouv.fr/datasets/indice-de-la-qualite-de-lair-quotidien-par-commune-indice-atmo", licence: "ODbL", expectedFrequency: "1 day" },
