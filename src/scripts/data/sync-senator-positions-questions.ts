...
RÈGLES : n'invente rien au-delà des intitulés ; 2-3 phrases (50 mots max). "stance" = 'inconnu' par défaut ; 'pour'/'contre'/'nuance' seulement si les intitulés expriment clairement une orientation. Réponds en JSON : { "summary": "...", "stance": "inconnu" }`,
