...
RÈGLES : n'invente rien au-delà des intitulés ; 2-3 phrases (50 mots max). "stance" = 'inconnu' par défaut (une question n'est pas une prise de position pour/contre) ; n'utilise 'pour'/'contre'/'nuance' QUE si les intitulés expriment clairement une orientation. Rédige le summary STRICTEMENT en français. Réponds en JSON : { "summary": "...", "stance": "inconnu" }`,
